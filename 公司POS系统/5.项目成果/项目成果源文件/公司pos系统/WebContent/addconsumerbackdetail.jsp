...
<html>
  ...
  <body>
	...
	<table width="100%" height="44" bgcolor="#206AB3">
      <tr align="center"><td>
        <font color="#FFFFFF" size="5">销售退货管理</font>
	...
	<caption style="color:black;font-size:22px">退货信息</caption>
	...
	<br/>
	<font color="black" size="3">请在下表添加退货商品及数量</font>
	<table width="100%" border="0" cellspacing="1" bgcolor="black">
	<caption style="color:black;font-size:22px">退货明细</caption>
	  <tr bgcolor="#D1F1FE" align="center" height="40px">
	    <th>商品名称</th>
	    <th>商品数量</th>
	    <th>添加</th>
	  ...
	  <tr bgcolor="white" align="center">
	    ...
	    <td><img border="0" src="img/tj.gif" id="tj" onclick="JavaScript:check()" style="cursor:hand"/></td>
	  </tr>
