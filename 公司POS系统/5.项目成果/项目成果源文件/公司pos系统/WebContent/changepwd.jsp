	  ...
	  <form action="ManageServlet" method="post" id="mf" target="bottom">
	    <table>
		  ...
		  <tr>
		    ...
		    <img border="0" src="img/sm.gif" id="xg" onclick="JavaScript:check()" style="cursor:hand" onmouseover="document.all.xg.src='img/sma.gif'"/>
		    <img border="0" src="img/cz.gif" id="cz" onclick="JavaScript:document.all.mf.reset()" style="cursor:hand" onmouseover="document.all.cz.src='img/cza.gif'"/></td>
		  </tr>
	    </table>
