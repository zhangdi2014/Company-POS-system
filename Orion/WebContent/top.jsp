...
<style>
	body{height:100%;background:#0080ff;overflow:hidden;}
...
<div class="head ">
  <div class="cont">
    ...
    <div class="nav"> 
      ...
      <div id="box-3" class="hidden-box hidden-loc-info" style="width:150px">
        <ul>
          <li><a href="statistic.jsp" target="mainFrame" class="to top" >库存统计</a></li>
        </ul>
      </div>
      <div id="box-4" class="hidden-box hidden-loc-info box04" style="width:150px">
        <ul>
